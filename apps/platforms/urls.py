...
urlpatterns = [
    ...
    path('superadmin/plataformas/<int:pk>/editar/', views.editar_plataforma, name='sa_editar_plat'),
    path('superadmin/plataformas/<int:pk>/cancelar/', views.cancelar_editar_plataforma, name='sa_cancelar_editar_plat'),
]
